...
function boardHasBingo(board) {
	for (let i = 0; i < 5; i++) {
		rowSum = board.markings[i][[0]] + board.markings[i][1] + board.markings[i][2] + board.markings[i][3] + board.markings[i][4];
		columnSum = board.markings[0][i] + board.markings[1][i] + board.markings[2][i] + board.markings[3][i] + board.markings[4][i];

		if (rowSum == 5 || columnSum == 5) return true;
		else return false;
	}
	return null;
}
...
// let winner = getWinningNumberAndBoard(numbersToDraw, bingoBoards);
let winner = getFirstWinningNumberAndBoard(testNumbersToDraw, testBingoBoards);
let winningNumber = winner[0];
let winningBoard = winner[1];

console.log('winning number:', winningNumber);
console.log('winning board:', winningBoard);
console.log('score: ', getBingoBoardScore(winningNumber, winningBoard));
